...
$(document).ready(function () {
                        ...
                        success: function (data) {
                            ...
                            if (data.copy != 0) {
                                if (data.unzip == 1) {
                                    ...
                                    $.growlUI('Update Successful! <br> Reloading Logarr in 5 seconds...');
    ...
    $.ajax({
        ...
        error: function () {
            ...
            //versionCheckAuto.html('<strong>An error occured while checking your Logarr version test.</strong>');
