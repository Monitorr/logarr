...
$(document).ready(function(){
	...
	$.ajax({
	   beforeSend: function(){
		   $('#version_check_auto').html('<img src="../../images/loader.gif" width="16" height="16" />');
	   },
	   type: "POST",
	   ...
	   error: function() {
		   // error
		   $('#version_check_auto').html('<strong> An error occured while checking your Logarr version </strong>');
	   }
	});
